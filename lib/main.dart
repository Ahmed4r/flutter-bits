...
import 'package:flutterbits/InteractiveAuroraBackground.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: InteractiveAuroraBackground(
        child: SelectionArea(
        ...
        children: [
          Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xff027DFD).withOpacity(0.1),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Icon(
                      ...
                      size: 14,
                      color: const Color(0xff05D1FF).withOpacity(0.5),
                    ),
                  ],
                ),
              )
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Icon(
              icon,
              color: const Color(0xff027DFD).withOpacity(0.8),
              size: 28,
            ),
            const Spacer(),
            Text(
